...
class Dashboard:
    ...
    def __init__(self, bus):
        ...
        try:
            ...
            self.speedometer_icon = self._create_dummy_icon(Config.PALE_GRAY)
        ...
        try:
            ...
            self.engine_icon = self._create_dummy_icon(Config.RED)

        try:
            self.radiation_icon = pygame.image.load('./assets/dashboard/radiation.png').convert_alpha()
            self.radiation_icon = pygame.transform.scale(self.radiation_icon, (30, 30))
        except FileNotFoundError:
            self.radiation_icon = self._create_dummy_icon(Config.GREEN)
    ...
    def draw(self, surface):
        ...
        # Радиация
        if self.bus.radiation_level > 1:
            radiation_x = self.padding + self.spacing * 7
            surface.blit(self.radiation_icon, (radiation_x, Config.SCREEN_HEIGHT - 50))
